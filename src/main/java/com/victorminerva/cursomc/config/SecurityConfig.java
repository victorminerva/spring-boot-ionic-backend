...
import com.victorminerva.cursomc.security.JWTAuthenticationFilter;
import com.victorminerva.cursomc.security.JWTAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	CorsConfigurationSource corsConfigurationSource() {
		CorsConfiguration configurationCors = new CorsConfiguration().applyPermitDefaultValues();
		configurationCors.setAllowedMethods(Arrays.asList("POST", "GET", "PUT", "DELETE", "OPTIONS"));
		
		final UrlBasedCorsConfigurationSource source = new UrlBasedCorsConfigurationSource();
		source.registerCorsConfiguration("/**", configurationCors);
